      ...
      try {
        ...
        await html5QrCode.start(
          ...
          async (decodedText) => {
            ...
            console.log(`Quick scanning: ${decodedText} for store ${selectedStore}`);
            
            // Look up the part with store filter
            const { data: partData, error: partError } = await supabase
              .from('parts')
              .select('*')
              .eq('part_number', decodedText)
              .eq('store_location', selectedStore) // Filter by user's store
              .single();
              ...
              <div className="p-6 bg-green-50 rounded-lg">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-center mt-2">
                    <p className="text-xs text-gray-500">Store {quickScanResult.store_location}</p>
                  </div>
                </div>
                <button
                  onClick={closeQuickScan}
