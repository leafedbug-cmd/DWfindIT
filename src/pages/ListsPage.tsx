...
import type { ListWithCount } from '../store/listStore'; // Import the new type
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col pb-16">
      ...
      <main className="flex-1 p-4 space-y-4">
        ...
        <div className="space-y-3">
          ...
          {!isLoading && lists.map((list: ListWithCount) => {
            // This line now correctly gets the count
            const itemCount = list.scan_items[0]?.count || 0;
                ...
                >
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <button
                      ...
                      className={`p-1 rounded-full hover:bg-gray-100 transition-transform transform ${isExpanded ? 'rotate-180' : ''}`}
                    >
